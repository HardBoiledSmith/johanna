...
def run_create_eb_django(name, settings):
    ...
    result, error = subprocess.Popen(git_command, cwd=environment_path).communicate()
    print('result:', result)
    print('error:', error)
    ...
    cmd += ['--solution-stack-name', '64bit Amazon Linux 2018.03 v2.7.4 running Python 3.6']
