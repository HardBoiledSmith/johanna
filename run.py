...
command_list.append('create_s3_srr')
...
command_list.append('terminate_s3_srr')
...
if __name__ == "__main__":
    ...
    if command == 'run_create':
        __import__('run_create_appstream_builder')
        __import__('run_create_appstream_fleet_autoscale')
        __import__('run_create_appstream_stack_fleet')
        __import__('run_create_cloudfront')
        __import__('run_create_cloudwatch_alarm')
        __import__('run_create_cloudwatch_dashboard')
        __import__('run_create_eb')
        __import__('run_create_ec2_keypair')
        __import__('run_create_ec2_route53')
        __import__('run_create_iam')
        __import__('run_create_lambda')
        __import__('run_create_rds')
        __import__('run_create_s3')
        __import__('run_create_s3_srr')
        ...
        __import__('run_terminate_appstream_builder')
        __import__('run_terminate_appstream_fleet_autoscale')
        __import__('run_terminate_appstream_stack_fleet')
        __import__('run_terminate_cloudfront')
        ...
        __import__('run_terminate_route53')
        __import__('run_terminate_s3')
        __import__('run_terminate_s3_srr')
