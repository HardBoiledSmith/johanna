...
def filter_gendo_arn_list(target_resouce_list):
    arn_list = list()
...
def run_terminate_image(name):
    ...
    ami_arn_list = filter_gendo_arn_list(rr['imageVersionList'])
    ...
    pipe_line_list = filter_gendo_arn_list(rr['imagePipelineList'])
    ...
    distribution_list = filter_gendo_arn_list(rr['distributionConfigurationSummaryList'])
    ...
    infrastructure_list = filter_gendo_arn_list(rr['infrastructureConfigurationSummaryList'])
    ...
    image_recipe_list = filter_gendo_arn_list(rr['imageRecipeSummaryList'])
    ...
    component_list = filter_gendo_arn_list(rr['componentVersionList'])
...
#
################################################################################
print_session('terminate imagebuilder gendo')
